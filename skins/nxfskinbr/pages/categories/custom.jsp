...
void insert(CategoryCustomDao dao){
	...
	if(dao.insert(data)){
		succ_list.add("Custom Category added successfully!");
	}
}
...
void delete(CategoryCustomDao dao){
	if(dao.delete(param_int("id"))){
		succ_list.add("Custom Category deleted.");
	}
}
%>
<%
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | Custom</title>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="../../pages/categories/custom.jsp"><i class="fa fa-angle-double-right"></i> Custom</a></li>
                                <li class="treeview">
                                    <a href="#">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box box-navy">
                                ...
                                <div class="box-body">
                                    <!-- start form -->
                                    <form role="form" id="addCat" action="<%= get_page_name()%>" method="post">
                                ...
                                <div class="box-footer">
                                    <button id="add" type="submit" form="addCat" class="btn btn-info">Add Category</button>
                                </div>
                            </div><!-- /.box -->
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                        ...
                        <div class="col-xs-12">
                            <div class="box box-solid box-grey">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Custom Category List</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
...
for(int i = 0; i < data_list.size(); i++){
    ...
    out.println("{\"id\": " + data.id + ",\"name\": \"" + name + "\",\"description\": \"" + data.description + "\",\"domain\": \"" + domain_line + "\"},");
...
window.operateEvents = {
    'click .edit': function (e, value, row, index) {
        ...
        goForm(row.id, row.name, "", "custom_edit.jsp");
    },
    'click .remove': function (e, value, row, index) {
        $('#myModal').data('id', row.id);
        $('#warn').html("The Custom Category \"" + row.name + "\" will be removed from all policies!");
        $('#myModal').modal('show');
    }
};             
        </script>
