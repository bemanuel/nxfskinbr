...
void insert(LdapDao dao){
	...
	if(dao.insert(data)){
		succ_list.add("LDAP settings added successfully!");
	}
}

//-----------------------------------------------
void delete(LdapDao dao){
	if(dao.delete(param_int("id"))){
		succ_list.add("LDAP settings & information deleted!");
	}
}

//-----------------------------------------------
void test(LdapDao dao){
	try{
		dao.test(param_int("id"));
		succ_list.add("LDAP connection test succeeded!");
	}
	catch(Exception e){
...
//-----------------------------------------------
void import_ldap(LdapDao dao){
	String res = dao.import_ldap(param_int("id"));
    if(res != null){
        succ_list.add("LDAP information successfully imported!");
        succ_list.add(res);
    } else {
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | LDAP</title>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="../../pages/directory/ldap.jsp"><i class="fa fa-angle-double-right"></i> LDAP</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box box-navy">
                                ...
                                <div class="box-body">
                                    <!-- start form -->
                                    <form role="form" id="addLDAP" action="<%= get_page_name()%>" method="post">
                                    <input type="hidden" name="action_flag" value="insert">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group col-xs-3">
                                                <label class="control-label" for="admin">Directory Administrator</label>
                                                <input type="text" class="form-control" id="admin" name="admin" placeholder="Admin...">
                                            </div>
                                            <p class="help-block">ex) cn=admin,dc=nxfilter,dc=local</p>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group col-xs-3">
...
%>
                                ...
                                <div class="box-footer">
                                    <button id="add" type="submit" form="addLDAP" class="btn btn-info">Add Directory</button>
                                </div>
                            </div><!-- /.box -->
                        </div><!-- /.col -->
                    </div><!-- /.row -->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#add').click(function() {
                    document.getElementById("addLDAP").submit();        
                });
                
                $('#addLDAP').submit(function(e) {
                    e.preventDefault();
                });
...
for(int i = 0; i < data_list.size(); i++){
    ...
    out.println("{\"id\": " + data.id + ",\"host\": \"" + data.host + "\",\"admin\": \"" + data.admin + "\",\"basedn\": \"" + data.basedn + "\",\"period\": \"" + get_ldap_period_string(data.period) + "\"},");
...
window.operateEvents = {
    ...
    'click .edit': function (e, value, row, index) {
        ...
        goForm(row.id, row.host, "", "ldap_edit.jsp");
    },
