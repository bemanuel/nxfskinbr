...
void update(PolicyApplicationDao dao){
	...
	kw = dao.find_invalid_kw(data.title);
	if (is_not_empty(kw)) {
		err_list.add("Invalid keyword for blocked window title, minimum length = 4! - " + kw);
		return;
	}

	if(dao.update(data)){
		succ_list.add("Application Control settings updated successfully!");
	}
}
%>
<%
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | Application Control</title>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="../../pages/policies/application.jsp"><i class="fa fa-angle-double-right"></i> Application</a></li>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Policies
                        <small>Application Control</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="../../dashboard.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Policies</a></li>
                        <li class="active">Application Control</li>
                    </ol>
                </section>
                ...
                <section class="content">       
                    ...
                    <div class="callout callout-warning">
                        <h4 class="text-maroon">Application control requires NxLogon or NxClient running on the client OS.</h4>
                    </div>

                    <!-- form start -->
                    <form role="form" id="application" action="<%= get_page_name()%>" method="post">
                    <input type="hidden" name="action_flag" value="update">
                        <div class="box box-maroon">
                            ...
                            <div class="box box-maroon">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Application Control Settings</h3>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <label class="control-label" for="enable_control">Enable Control</label>
                                                <br />
                                                <input type="checkbox" class="flat-green" id="enable_control" name="enable_control" <%if(data.enable_control){out.print("checked");}%> >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" for="execution_interval">Execution Interval</label>
                                            <div class="input-group col-xs-2">
                                                <input type="text" class="form-control" id="execution_interval" name="execution_interval" value="<%= data.execution_interval%>" maxlength="4" >
                                                <span class="input-group-addon">seconds</span>
                                            </div>
                                            <p class="help-block">15 ~ 300 seconds </p>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                                                <label class="control-label" for="block_ultrasurf">Block UltraSurf</label>
                                                <br />
                                                <input type="checkbox" class="flat-green" id="block_ultrasurf" name="block_ultrasurf" <%if(data.block_ultrasurf){out.print("checked");}%> >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                                                <label class="control-label" for="block_tor">Block Tor</label>
                                                <br />
                                                <input type="checkbox" class="flat-green" id="block_tor" name="block_tor" <%if(data.block_tor){out.print("checked");}%> >
                                            </div>
                                        </div>                                        
                                    </div><!-- /.box-body -->
                            </div><!-- /.box box-maroon -->  
                            ...
                            <div class="box box-lime">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Block by Process Name</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-default btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                    </div>
                                </div><!-- /.box-header -->
                                    <div class="box-body">
                                        ...
                                        <div class="callout callout-info">
                                            <h4>NxFilter tries to find and kill the processes running on a user's PC based on keyword matching against the process name.</h4>
                                            <p>You can add keywords in the following forms.</p>
                                            <dl class="dl-horizontal">
                                                <dt>Skype Dropbox</dt>
                                                <dd>Keywords separated by spaces</dd>
                                                <dt>[uTorrent.exe]</dt>
                                                <dd>For exact matching of process name, use square brackets</dd>
                                            </dl>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" for="pname">Process Names</label>
                                            <div class="input-group col-xs-12">
                                                <textarea class="form-control" id="pname" name="pname" rows="4"><%= data.pname%></textarea>
                                            </div>
                                        </div>
                            ...
                            <div class="box box-navy">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Block by Window Title</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-default btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                    </div>
                                </div><!-- /.box-header -->
                                    <div class="box-body">
                                        ...
                                        <div class="callout callout-info">
                                            <h4>If it's a Windows program having a window title, NxFilter can block it based on keyword matching against the window title.</h4>
                                            <p>You can add keywords in the following forms.</p>
                                            <dl class="dl-horizontal">
                                                <dt>"Tor Browser"</dt>
                                                <dd>Keywords separated by spaces use double quotes</dd>
                                                <dt>[UltraSurf 13.04]</dt>
                                                <dd>For exact matching of window title, use square brackets</dd>
                                            </dl>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" for="title">Window Titles</label>
                                            <div class="input-group col-xs-12">
                                                <textarea class="form-control" id="title" name="title" rows="4"><%= data.title%></textarea>
                                            </div>
                                        </div>
                            ...
                            <div class="box box-teal">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Exclude Keywords</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-default btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                    </div>
                                </div><!-- /.box-header -->
                                    <div class="box-body">
                                        ...
                                        <div class="callout callout-info">
                                            <h4>Bypass process name or window title controls by keywords.</h4>
                                            <p>When you try to kill a program based on its process name or window title you might have some false positives. It happens especially to browsers changing their window titles with the webpages loaded. You can bypass these programs with keywords.</p>
                                            <dl class="dl-horizontal">
                                                <dt>Explorer Firefox Chrome</dt>
                                                <dd>Keywords for common browsers</dd>
                                            </dl>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" for="exclude">Keywords</label>
                                            <div class="input-group col-xs-12">
                                                <textarea class="form-control" id="exclude" name="exclude" rows="4"><%= data.exclude%></textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="box-footer">
                            <div class="btn-group">
                                <button id="submitBtn" type="submit" form="application" class="btn btn-info margin">Save Settings</button>
