...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | 404 Error</title>
    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <!-- search form -->
                    <form action="../pages/search.jsp" method="get" class="sidebar-form">
            ...
            <aside class="right-side">
                ...
                <section class="content">       
                     ...
                     <div class="error-page">
                        <h2 class="headline text-info fadeInLeftBig animated">404 
                        ...
                        <div class="error-content">
                            ...
                            <p>
                                ...
                                Meanwhile, you may <a href='../../dashboard.jsp'>return to the dashboard</a> or try using the search form.
                            </p>
                            <form class='search-form' action="../pages/search.jsp">
                                <div class='input-group'>
                                    <input type="text" name="q" class="form-control" placeholder="Search..." id="tipue_search_input" autocomplete="off" required/>
        ...
        <!-- Tipue Search -->
        <script src="../../js/plugins/tipue/tipuesearch_set.js" type="text/javascript"></script>
        <script src="../../js/plugins/tipue/tipuesearch.js" type="text/javascript"></script>
