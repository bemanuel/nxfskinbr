...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | 500 Error</title>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="text-center error-box">
                                        <h1 class="error-text wobble animated">
                                            <i class="fa fa-times-circle text-danger error-icon-shadow"></i>
                                            Error 500
                                        </h1>
                                        <h2 class="font-xl"><strong>Something has gone horribly wrong!</strong></h2>
                                        <br>
                                        <p class="lead semi-bold">
                                            ...
                                            <br>
                                            <small>
                                                We work hard to prevent these issues. Please take time to report errors so that we may address them.
                                            </small>
                                        </p>
                                    </div>
                                </div>
