...
String g_etime = strftime_add("yyyyMMdd", 86400 * -1);
String g_stime = strftime_add("yyyyMMdd", 86400 * -30);
...
Date dStart = sdfOrig.parse(g_stime);
Date dEnd = sdfOrig.parse(g_etime);
