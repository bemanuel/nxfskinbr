...
void insert(GroupDao dao){
	...
	if (pv.is_dup_group(data.name)) {
		err_list.add("This Group already exists!");
		return;
	}

	if(dao.insert(data)){
		succ_list.add("Group successfully added.");
	}
}
...
void delete(GroupDao dao){
	if(demo_flag){
		err_list.add("Deleting Groups not allowed on demo site!");
		return;
	}

	if(dao.delete(param_int("id"))){
		succ_list.add("Group was successfully deleted.");
	}
}
%>
<%
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | Groups</title>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="../../pages/directory/groups.jsp"><i class="fa fa-angle-double-right"></i> Groups</a></li>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box box-navy">
                                ...
                                <div class="box-body">
                                    <!-- start form -->
                                    <form role="form" id="addGroup" action="<%= get_page_name()%>" method="post">
                                ...
                                <div class="box-footer">
                                    <button id="add" type="submit" form="addGroup" class="btn btn-info">Add Group</button>
                                </div>
                            </div><!-- /.box -->
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                                ...
                                <div class="box-body">
                                    ...
                                    <table id="table" data-pagination="true" data-search="true" data-classes="table table-hover table-condensed">
                                        ...
                                        <tr>
                                            ...
                                            <th data-field="ldap" data-sortable="true">LDAP</th>
...
for(int i = 0; i < data_list.size(); i++){
    ...
    out.println("{\"id\": " + data.id + ",\"name\": \"" + data.name + "\",\"ldap\": \"" + data.get_ldap_yn() + "\",\"policy\": \"" + data.policy_name + "\",\"user\": \"" + user_line + "\",\"description\": \"" + data.description + "\"},");
...
window.operateEvents = {
    'click .edit': function (e, value, row, index) {
        ...
        goForm(row.id, row.name, "", "group_edit.jsp");
    },
