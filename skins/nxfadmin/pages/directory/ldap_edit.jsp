...
void update(LdapDao dao){
	...
	if (!is_valid_ip(data.host)) {
		err_list.add("LDAP Host is Invalid!");
		return;
	}
	...
	if (is_empty(data.basedn)) {
		err_list.add("LDAP Base DN is missing!");
		return;
	}

	if(dao.update(data)){
		succ_list.add("LDAP settings updated successfully!");
	}
}
%>
<%
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | Edit LDAP</title>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Users & Groups
                        <small>Edit LDAP</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="../../dashboard.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Users & Groups</a></li>
                        <li class="active">Edit LDAP</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-navy">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Edit LDAP Settings</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <!-- start form -->
                                    <form role="form" id="updateLDAP" action="<%= get_page_name()%>" method="post">
                                    ...
                                    <input type="hidden" name="id" value="<%= data.id%>">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group col-xs-3">
                                                <label class="control-label" for="admin">LDAP Administrator</label>
                                                <input type="text" class="form-control" id="admin" name="admin" value="<%= data.admin%>" placeholder="Admin...">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group col-xs-3">
                                                <label class="control-label" for="passwd">Password</label>
                                                <input type="password" class="form-control" id="passwd" name="passwd" value="<%= data.passwd%>" placeholder="Password...">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group col-xs-4">
                                                <label class="control-label" for="basedn">Base DN</label>
                                                <input type="text" class="form-control" id="basedn" name="basedn" value="<%= data.basedn%>" placeholder="Base DN...">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
...
%>
                                        ...
                                        <div class="callout callout-info">
                                            ...
                                            <p>When you do not wish to import certain LDAP users or groups, you can exclude those users or groups based on keyword matching.</p>
                                            <dl class="dl-horizontal">
                                                <dt>"Home Office"</dt>
                                                <dd>Use double quotes for keyword having whitespace in the name.</dd>
                                                <dt>[DHCP Users]</dt>
                                                <dd>Use square brackets for exact matching.</dd>
                                            </dl>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label" for="exclude_keyword">Keywords</label
                                            <div class="input-group col-xs-12">
                                                <textarea class="form-control" id="exclude_keyword" name="exclude_keyword" rows="6"><%= data.exclude_keyword%></textarea>
                                            </div>
                                            <p class="help-block">ex) support devel [DHCP Users] "main Co" john </p>
                                        </div>
                                    </form><!-- end form -->
                                </div><!-- /.box-body -->
                                <div class="box-footer">
                                    <div class="btn-group">
                                        <button id="update" type="submit" form="updateLDAP" class="btn btn-info margin">Update Settings</button>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#update').click(function() {
                    document.getElementById("updateLDAP").submit();        
                });
                
                $('#resetBtn').click(function() {
                    document.getElementById("updateLDAP").reset();        
                });
                
                $('#updateLDAP').submit(function(e) {
                    e.preventDefault();
                });
