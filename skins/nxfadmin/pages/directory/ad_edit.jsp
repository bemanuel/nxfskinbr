...
void update(AdapDao dao){
	...
	if(dao.update(data)){
		succ_list.add("AD settings updated successfully!");
	}
}
%>
<%
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | Edit AD</title>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-navy">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Edit AD Settings</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <!-- start form -->
                                    <form role="form" id="updateAD" action="<%= get_page_name()%>" method="post">
                                    ...
                                    <input type="hidden" name="id" value="<%= data.id%>">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group col-xs-4">
                                                ...
                                                <input type="text" class="form-control" id="domain" name="domain" value="<%= data.domain%>" placeholder="Domain...">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <br />
                                                <input type="checkbox" class="flat-green" id="zone_transfer" name="zone_transfer" <%if(data.zone_transfer){out.print("checked");}%>>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
...
%>
                                        ...
                                        <div class="callout callout-info">
                                            ...
                                            <p>When you do not wish to import certain AD users or groups, you can exclude those users or groups based on keyword matching.</p>
                                ...
                                <div class="box-footer">
                                    <div class="btn-group">
                                        <button id="update" type="submit" form="updateAD" class="btn btn-info margin">Update Settings</button>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#resetBtn').click(function() {
                    document.getElementById("updateAD").reset();        
                });
