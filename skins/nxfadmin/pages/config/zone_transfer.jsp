...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | Zone Transfer</title>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="../../pages/config/zone_transfer.jsp"><i class="fa fa-angle-double-right"></i> Zone Transfer</a></li>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Configuration
                        <small>Zone Transfer</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="../../dashboard.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Configuration</a></li>
                        <li class="active">Zone Transfer</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-solid">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Zone Transfer</h3>
