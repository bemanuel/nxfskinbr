...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | Search</title>
        ...
        <link href="../css/tipue/tipuesearch.css" rel="stylesheet" type="text/css" />
        <!-- Ionicons -->
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <!-- search form -->
                    <form action="search.cgi" method="get" class="sidebar-form" name="search">
                        <div class="input-group">
                            <input type="text" name="q" class="form-control" placeholder="Search..." id="tipue_drop_input" autocomplete="off" required disabled/>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-solid">
                                ...
                                <div class="box-body">
                                    ...
                                    <form class="search-form" action="<%= get_page_name()%>">
