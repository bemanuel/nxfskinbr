...
if(g_blacklist_type < 3 && !dao.is_blacklist_imported()
	...
	err_list.add("A blacklist has not been imported yet!");
}
%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | System</title>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="../../pages/categories/system.jsp"><i class="fa fa-angle-double-right"></i> System</a></li>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box box-navy">
                                ...
                                <div class="box-body">
                                    <!-- start form -->
                                    <form role="form" id="system" action="<%= get_page_name()%>" method="post">
                                    <input type="hidden" name="action_flag" value="update">

                                        <div class="callout callout-info">
                                            <h4>Supported Blacklists</h4>
                                            <p>To find out more about these blacklist options and how to import them, read our online tutorial <a href="http://www.nxfilter.org/tutorial.html#whatblacklist">here</a>.</p>
                                            <p>Blacklist types:</p>
                                ...
                                <div class="box-footer">
                                    <button id="update" type="submit" form="system" class="btn btn-info">Save Settings</button>
                                </div>
                            </div><!-- /.box -->
                        </div><!-- /.col -->
                    </div><!-- /.row -->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#update').click(function() {
                    document.getElementById("system").submit();        
                });
