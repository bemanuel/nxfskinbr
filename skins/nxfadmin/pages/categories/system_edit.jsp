...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | System Edit</title>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Categories
                        <small>System Edit</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="../../dashboard.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Categories</a></li>
                        <li class="active">System Edit</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-navy">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">System Category</h3>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-solid box-grey">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">System Category Domain List</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
