...
void insert(WhitelistKeywordDao dao){
	...
	// Param validation.
	if(is_empty(data.keyword) || data.keyword.matches(".*\\s+.*")){
		err_list.add("Invalid keyword!");
		return;
	}

	if(dao.insert(data)){
		succ_list.add("Whitelist keyword added successfully!");
	}
}
...
void delete(WhitelistKeywordDao dao){
	if(dao.delete(param_int("id"))){
		succ_list.add("Whitelist keyword deleted.");
	}
}
%>
<%
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | By Keyword</title>
    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="treeview active">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li class="active"><a href="../../pages/categories/keyword.jsp"><i class="fa fa-angle-double-right"></i> By Keyword</a></li>
                                    </ul>
                                </li>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Categories
                        <small>Whitelist by Keyword</small>
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="col-xs-12">
                            <div class="box box-navy">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Whitelist by Keyword</h3>
                                ...
                                <div class="box-body">
                                    <!-- start form -->
                                    <form role="form" id="addKeyword" action="<%= get_page_name()%>" method="post">
                                    <input type="hidden" name="action_flag" value="insert">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="help-block"><span class="text-warning">When you want to block a domain by keyword regardless of your policy, use this option.</span></p>
                                        </div> 
                                    </form><!-- end form -->
                                </div><!-- /.box-body -->
                                <div class="box-footer">
                                    <button id="add" type="submit" form="addKeyword" class="btn btn-info">Add Keyword</button>
                                </div>
                            </div><!-- /.box -->
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                        ...
                        <div class="col-xs-12">
                            <div class="box box-solid box-grey">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Whitelist Keywords</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#add').click(function() {
                    document.getElementById("addKeyword").submit();        
                });
...
for(int i = 0; i < data_list.size(); i++){
    ...
    out.println("{\"id\": " + data.id + ",\"keyword\": \"" + data.keyword + "\",\"flags\": \"" + data.get_flag_line() + "\",\"policy\": \"" + data.get_applied_policy_line() + "\"},");
...
window.operateEvents = {
    'click .edit': function (e, value, row, index) {
        ...
        goForm(row.id, "", "", "keyword_edit.jsp");
    },
    'click .remove': function (e, value, row, index) {
        $('#myModal').data('id', row.id);
        $('#warn').html("The whitelist keyword entry for \"" + row.keyword + "\" will be removed!");
        $('#myModal').modal('show');
    }
};             
        </script>
