...
<html>
    <head>
        <meta charset="UTF-8">
        <title>NxFilter v<%= GlobalDao.get_nx_version()%> | EMPTY</title>
    ...
    <body class="skin-black">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li>
                                            <a href="#">
                                                <i class="ion ion-loop warning"></i> Lost connection to cluster slave
                                            </a>
                                        </li>
                                    </ul>
                                </li>
        ...
        <!-- NxF dashboard demo (This is only for demo purposes) -->
